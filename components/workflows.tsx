...
export default function Workflows() {
  const cards = [
    ...
    },
    {
      ...
      imageAlt: "Purpose and Projects",
      badgeText: "Purpose & Projects",
      description:
    ...
    },
    {
      ...
      imageAlt: "Market Performance",
      badgeText: "Market Performance",
      description:
    ...
    },
    {
      href: "#0",
      imageSrc: WorflowImg03,
      imageAlt: "Community Sentiment",
      badgeText: "Community Sentiment",
      description:
        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.indigo.200),theme(colors.gray.50),theme(colors.indigo.300),theme(colors.gray.200))] bg-[length:200%_auto] bg-clip-text pb-4 font-aperture text-3xl font-semibold text-transparent md:text-4xl">
              $TETSUO refers to a cryptocurrency token on the Solana blockchain,
              which has garnered attention for its community and objectives.
            </h2>
